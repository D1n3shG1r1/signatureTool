...
//--
    ...
    var readOnlyRequiredHtml = '<div class="readonlyRequiredContainer"><ul class="readonlyRequiredUl"><li class="readonlyRequiredLi"><input onchange="setRequiredField(this,\''+elmId+'\');" type="checkbox" id="requiredCheck" /><label for="requiredCheck">Required</label></li><li class="readonlyRequiredLi"><input onchange="setReadOnlyField(this,\''+elmId+'\');" type="checkbox" id="readOnlyCheck" /><label for="readOnlyCheck">Read Only</label></li></ul></div>';
