...
class GeneratePdf{
    ...
    function prepareConsolidatePdf($rootFolder, $srcFilePath, $data, $secretFolder){
       ...
       for($i = 1; $i <= $numPages; $i++){
		...
		//show the PDF in page
		//$this->pdf->Output();
        $this->pdf->Output("C:/wamp64/www/digitalsignature//userassets/mydocuments/1673874254153097/c.pdf", "F");
        //$this->pdf->Output($rootFolder."$secretFolder/$signerDocumentId/$signerDocumentId.pdf", "F");
